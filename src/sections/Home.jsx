...
const glowVariants = {    // it is for social icons glow effect
  ...
  hover: {
    ...
    transition: {type: 'spring', stiffness: 300, damping: 15}      // it is used when we hover on the icon
  },
  tap: {scale: 0.9, y:0, transition: {duration: 0.08}}      // it is used when we click on the icon
}
